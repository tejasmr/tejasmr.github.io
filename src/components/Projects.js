    ...
    <>
      <div id="projects">
        ...
        <div
          ...
          <div className="slds-text-color_inverse" style={{ fontSize: "14px", fontWeight: "normal", color: "#16325c", marginTop: "1rem", marginBottom: "1rem", maxWidth: "500px", textAlign: "center" }}>
